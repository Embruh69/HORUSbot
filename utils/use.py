...
class UseCog(commands.Cog, name="action"):
    ...
    async def _use_weapon(
        ...
        view = HeatHPView(guild_id=ctx.guild.id, user_id=ctx.author.id, hp_damage=target_hp_dmg, heat_gain=target_heat, self_hp_damage=self_hp_dmg, self_heat_gain=self_heat)
